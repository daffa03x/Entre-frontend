    ...
    >
      <div className="w-full max-w-md mx-auto min-h-screen bg-gray-50 pb-20 shadow-2xl">
        ...
        <div className="px-5 py-6">
          <h2 className="text-lg font-bold text-gray-800 mb-4 animate-fade-in">
            Kategori
          </h2>
          <div className="grid grid-cols-4 gap-3">
            {categories.map((cat, idx) => (
              ...
              >
                <div
                  className={`${cat.color} p-3.5 rounded-xl shadow-sm group-hover:scale-110 group-hover:rotate-6 transition-all duration-300`}
                >
          ...
          <div className="bg-linear-to-r from-purple-600 via-purple-500 to-blue-600 rounded-2xl p-6 text-white shadow-lg relative overflow-hidden group hover:shadow-2xl transition-all duration-500">
            ...
            <div className="relative z-10 flex items-center justify-between">
              <div>
                ...
                <h3 className="text-2xl font-bold mb-1 group-hover:scale-110 transition-transform duration-300 inline-block">
                  Diskon 30%
                </h3>
          ...
          <div className="space-y-4">
            {events.map((event, idx) => (
              ...
              >
                ...
                <div className="p-4">
                  <h3 className="font-bold text-gray-800 mb-2.5 text-base line-clamp-1 hover:text-purple-600 transition-colors duration-300">
                    {event.title}
                  </h3>
                  <div className="flex items-center gap-2 text-sm text-gray-600 mb-1.5 group/date hover:text-purple-600 transition-colors duration-300">
                    <Calendar
                      size={16}
                      className="text-purple-500 group-hover/date:scale-125 transition-transform duration-300"
                    />
                  ...
                  <div className="flex items-center gap-2 text-sm text-gray-600 mb-4 group/location hover:text-purple-600 transition-colors duration-300">
                    <MapPin
                      size={16}
                      className="text-purple-500 group-hover/location:scale-125 transition-transform duration-300"
                    />
                  ...
                  <div className="flex items-center justify-between">
                    <div>
                      ...
                      <p className="text-lg font-bold text-purple-600 hover:scale-110 transition-transform duration-300 inline-block">
                        {event.price}
                      </p>
                    </div>
